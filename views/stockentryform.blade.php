...
@push('pageScripts')
	<script>
		// Add OK button next to the close button in the embedded top bar
		var topBar = document.querySelector('.fixed-top');
		if (topBar) {
			var okBtn = document.createElement('button');
			okBtn.type = 'button';
			okBtn.className = 'btn btn-success btn-sm mr-1';
			okBtn.textContent = {!! json_encode($__t('OK')) !!};
			okBtn.addEventListener('click', function () {
				document.getElementById('save-stockentry-button').click();
			});
			topBar.insertBefore(okBtn, topBar.firstChild);
		}
	</script>
@endpush
